...
bot.onText(/\/start/, (msg) => {
  const chatId = msg.chat.id;
    ...
    const welcomeText =
      ...
      'Что здесь можно:\n' +
      '✨ Ознакомиться с проектами строительно-риэлторской компании «Уютный дом» (domuyut38.ru)\n' +
      ...
      'Нажми «Открыть каталог» — и найди идеальный проект дома, который мы Вам с радостью построим! 🏡';
